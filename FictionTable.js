	...
	return function(a,b){
		...
		for(var c=SortSetting.length-1;c>=0;c--){
			function normalize(x){ 
				//console.log(SortSetting[c].key in IndexObj.dataType, IndexObj.dataType[SortSetting[c].key]);
				if(SortSetting[c].key in IndexObj.dataType && IndexObj.dataType[SortSetting[c].key] == 'date'){
					//console.log('date');
					var temp = x.split('/');
